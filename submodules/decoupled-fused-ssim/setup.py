...
def configure_cuda():
    ...
    return CUDAExtension, ["ssim.cu", "ssim3d.cu", "ext.cpp"], "decoupled_fused_ssim_cuda", compiler_args, [], detected_arch
...
def configure_mps():
    ...
    return CppExtension, ["ssim.mm","ext.cpp"], "decoupled_fused_ssim_mps", compiler_args, link_args, "Apple Silicon (MPS)"
...
def configure_xpu():
    ...
    return CppExtension, ["ssim_sycl.cpp","ext.cpp"], "decoupled_fused_ssim_xpu", compiler_args, link_args, detected_arch
