...
if __name__ == "__main__":
    ...
    # read scene.json
    cmd = f"python run.py --dataset-dir {scene} --ply-path {ply_file} --traj-path {TNT_Dataset}/Truck/Truck_COLMAP_SfM.log --ply-path {TNT_Dataset}/Truck/Truck_COLMAP.ply --out-dir output"
    print()
    print(cmd)
    print()
    os.system(cmd)